...
<div id="leastSellingBooksCarousel" class="carousel slide mt-4 text-center container-fluid ms-0 me-0 px-3 py-3 mt-2" style="height: 70vh">
    ...
    <div class="carousel-inner rounded p-4 mx-auto" style="width:40vw; max-width: 40vw; max-height: 500px;">
        ...
        @endforeach
        <button class="carousel-control-prev" type="button" data-bs-target="#leastSellingBooksCarousel" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Anterior</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#leastSellingBooksCarousel" data-bs-slide="next">
